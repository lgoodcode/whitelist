            ...
            <ScrollAnimation animation="fadeInUp" delay={200}>
              <Box mt={4}>
                <Typography lineHeight="1.75" fontWeight="regular">
                  We provide quality cryptocurrency consultation and mining equipment installation
                  services. If you're interested in investing the ever growing blockhain industry
                  whether it is through long-term holding, similar to stocks, or mining equipment to
                  generate passive income, we are your go-to solution.
                </Typography>

                <Box display="flex" mt={3} justifyContent={{ xs: 'center', lg: 'start' }}>
                  <Button
                    color="secondary"
                    variant="contained"
                    size="large"
